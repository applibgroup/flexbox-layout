...
### Screenshots
<img src="screenshots/MainAbilitySlice.PNG" width=350 ></img> <img src="/screenshots/FlexboxLayoutSlice.PNG" width=350 ></img>
<img src="screenshots/FlexboxLayoutSlice_row.PNG" width=350 ></img> <img src="/screenshots/FlexboxLayoutSlice_column.PNG" width=350 ></img>
...
## Usage instructions
Add the `com.google.harmony.flexbox.FlexboxLayout` to your layout XML file.
```XML
...
### Setting Flexbox Layout properties
```java
...
flexLayout.setAlignContent(FLEX_END);
// To set Align Items
