 ...
 * Known classes that implement this interface are {@link FlexboxLayout.LayoutConfig}
 */
public interface FlexItem extends Sequenceable {
    ...
    int MAX_SIZE = Integer.MAX_VALUE & 0x00ffffff;

    /**
     * Get the configured item width
    ...
    /**
     * Get the configured item height
    ...
    /**
     * Get the configured item flex grow
    ...
    /**
     * Get the configured item flex shrink
    ...
    /**
     * Get the configured item align self
     ...
     */
    void setAlignSelf(AlignSelf alignSelf);

    /**
     * Get the configured item minimum width
    ...
    /**
     * Get the configured item minimum height
    ...
    /**
     * Get the configured item maximum width
    ...
    /**
     * Get the configured item maximum height
    ...
    /**
     * Get the configured item wrap before
     ...
     * specification, but having this attribute is useful for openharmony developers to flatten
    ...
    /**
     * Get the configured item basis percentage value
